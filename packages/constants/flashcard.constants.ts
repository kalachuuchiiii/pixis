...
export const TYPE_ENUM = ["open_ended", "close_ended"] as const;

export const CHOICES_MIN = 2;
export const CHOICES_MAX = 6;
export const SORTABLE_FLASHCARD_FIELDS = [
  "createdAt",
  "updatedAt",
] as const;
...
export type FlashcardFilterOperator = typeof FLASHCARD_FILTER_OPERATORS[number];
export type SortableFlashcardField = typeof SORTABLE_FLASHCARD_FIELDS[number];
export type FilterableFlashcardField = typeof FILTERABLE_FLASHCARD_FIELDS[number];
export type SearchableFlashcardField = typeof SEARCHABLE_FLASHCARD_FIELDS[number];
export type FlashcardType = typeof TYPE_ENUM[number];