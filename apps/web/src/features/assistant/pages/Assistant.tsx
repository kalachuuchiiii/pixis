  ...
  return (
    <>
            ...
            <div className="mt-2 flex flex-col gap-2">
              {[
                ...
                >
                  ...
                  <ArrowRight
                    size={12}
                    className="text-stone-300 group-hover:text-stone-500 flex-shrink-0 transition-colors"
                  />
                </button>
              ))}
            </div>
      ...
      <div className="flex-shrink-0  px-4 sm:px-8 py-4">
        <div className="flex items-end gap-2    rounded-2xl px-4 py-3 focus-within:border-stone-400  transition-colors">
          <Textarea
            rows={1}
            value={input}
...
const AssistantPage = () => {
  ...
  return (
    ...
    >
      {/* Top bar */}
      <div className="flex items-center justify-between px-5 py-3.5 border-b dark:border-stone-800 border-stone-100  flex-shrink-0 flex-wrap gap-3">
