  ...
  return (
    <>
      ...
      <div className="flex-shrink-0  px-4 sm:px-8 py-4">
        {/* Attachment preview */}
        {attachment && (
          <div className="mb-2 flex items-center gap-2 px-3 py-2 rounded-xl border border-zinc-200 bg-zinc-50 w-fit max-w-full">
            <FileText size={13} className="text-zinc-400 flex-shrink-0" />
            <span className="text-[12.5px] text-zinc-600 font-medium truncate max-w-[200px]">
              {attachment}
            </span>
            <button
              onClick={() => setAttachment(null)}
              className="text-zinc-300 hover:text-zinc-600 transition-colors ml-1 flex-shrink-0"
            >
              <X size={13} />
            </button>
          </div>
        ...
        <div className="flex items-end gap-2  rounded-2xl px-4 py-3  transition-colors">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Button
              ...
              variant="ghost"
              size="icon"
              className="h-10 w-10 rounded-xl text-zinc-400 hover:text-zinc-600 hover:bg-zinc-100 dark:hover:bg-zinc-800"
              title="Upload PDF"
            >
