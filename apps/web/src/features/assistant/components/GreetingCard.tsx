...
export const GreetingCard = ({ mode }: { mode: Mode }) => (
  <div className="flex gap-3">
    ...
    <div className="flex-1">
      <div className="bg-white border border-zinc-200 rounded-2xl rounded-tl-sm px-5 py-4 text-[13.5px] text-zinc-800 leading-relaxed">
        <p className="font-semibold text-zinc-900 mb-1">Hey, I'm Pixis 👋</p>
        {mode === "generate"
