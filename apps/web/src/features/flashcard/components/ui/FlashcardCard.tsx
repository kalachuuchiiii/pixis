        ...
        <DialogTrigger asChild>
          ...
          >
            <div className="space-y-2 w-full  h-full">
              ...
              <div className="h-full flex flex-col pb-4 items-start justify-between w-full">
                <h3 className="text-xl font-medium  leading-snug text-zinc-900 dark:text-white wrap break-all line-clamp-3 ">
                  {flashcard.question}
                </h3>
                {showAnswerImmediately && (
                  <p className="opacity-75 line-clamp-3 wrap break-all w-full">
                    {flashcard.answer}
                  </p>
                )}
              </div>
